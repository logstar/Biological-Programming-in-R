...
In 1900, Pearson published a paper on $\chi^2$ test. Although there are multiple variations of $\chi^2$ test, we use the function `chisq.test()` in R to perform the $\chi^2$ test practically. 
...
Following is an example of the joint distribution of 2 independent random variables from Wikipedia:
...
Understanding this, we obtained our null and alternative hypotheses of $\chi^2$ test:
...
In 1922, Fisher published the Fisher's exact test procedure in a paper with the title "On the Interpretation of $\chi^2$ from Contingency Tables, and the Calculation of P".
...
However, the odds ratio is slightly different from the results of `fisher.test()` that is `0.420428`. This is because `fisher.test()` estimate the odds ratio using a maximum likelihood estimate (MLE) method. The specific MLE method is out of the scope of this course, but you can check *Hauck 1984* if you are interested. 
...
In addition, the p-value definition here is quite different from our previous definitions, such as the p-value in z-test. However, keep in mind one interpretation of p-value: "a p-value is the probability getting a result as extreme or more extreme than the event you actually did observe". In two-tailed Fisher's exact test, the extremeness is the probability of observing a certain data (contingency table) under $H_0$, and we sum all probabilities lower than or equal to the current observation in two-tailed test. 
...
[1] K. P. F.R.S, “X. On the criterion that a given system of deviations from the probable in the case of a correlated system of variables is such that it can be reasonably supposed to have arisen from random sampling,” The London, Edinburgh, and Dublin Philosophical Magazine and Journal of Science, vol. 50, no. 302, pp. 157–175, Jul. 1900.

[2] “Chi-squared test,” Wikipedia, Feb. 2018.

[3] “Joint probability distribution,” Wikipedia, Oct. 2017.

[4] “9.1 - Chi-Square Test of Independence | STAT 500.” https://onlinecourses.science.psu.edu/stat500/node/56.

[5] R. A. Fisher, “On the Interpretation of XX2 from Contingency Tables, and the Calculation of P,” Journal of the Royal Statistical Society, vol. 85, no. 1, pp. 87–94, 1922.

[6] “Fisher’s exact test,” Wikipedia, Jan. 2018.

[7] W. W. Hauck, “A Comparative Study of Conditional Maximum Likelihood Estimation of a Common Odds Ratio,” Biometrics, vol. 40, no. 4, pp. 1117–1123, 1984.

[8] “3.3 - Two-way Tables - Exact Tests | STAT 504.” https://onlinecourses.science.psu.edu/stat504/node/89.

[9] “Contingency table,” Wikipedia, Feb. 2018.

[10] “Comparing Two Proportions | STAT 414 / 415.” https://onlinecourses.science.psu.edu/stat414/node/268.

[11] “8.1 - Comparing Two Population Proportions with Independent Samples | STAT 500.” https://onlinecourses.science.psu.edu/stat500/node/55.

[12] A. Agresti, “A Survey of Exact Inference for Contingency Tables,” Statistical Science, vol. 7, no. 1, pp. 131–153, Feb. 1992.

[13] “Cartesian product,” Wikipedia, Nov. 2017.

[14] “Hypergeometric distribution,” Wikipedia, Jan. 2018.

[15] “Hypothesis testing - Is ‘test statistic’ a value or a random variable? - Cross Validated.” https://stats.stackexchange.com/questions/85426/is-test-statistic-a-value-or-a-random-variable.

[16] “Exact test,” Wikipedia, Aug. 2017.

[17] “Hypergeometric Distribution | STAT 414 / 415.” https://onlinecourses.science.psu.edu/stat414/node/58.
